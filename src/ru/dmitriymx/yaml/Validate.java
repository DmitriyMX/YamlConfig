...
/**
 * Скомуниздено из {@code org.apache.commons.lang}
 * 
 * @author Дмитрий
 * 
 */
...
public class Validate {
	 ...
	 * @param message
	 *            the exception message you would like to see if the expression
	 *            is <code>false</code>
	 * @param value
	 ...
	 * and appended to the message string only in the case of an error.
	 * </p>
	 * 
	 * @param expression
	 *            a boolean expression
	 ...
	 * parameter and appended to the message string only in the case of an
	 * error.
	 * </p>
	 * 
	 * @param expression
	 ...
	 * append, instead use the {@link #isTrue(boolean, String, Object)} method.
	 * </p>
	 * 
	 * @param expression
	 *            a boolean expression
	 ...
	 * 
	 * @param object
	 *            the object to check is not <code>null</code>
	 * @param message
	 *            the exception message you would like to see if the object is
	 *            <code>null</code>
	 * @throws IllegalArgumentException
	 ...
	 * @param message
	 *            the exception message you would like to see if the array is
	 *            empty
	 * @throws IllegalArgumentException
	 ...
	 * @param message
	 *            the exception message you would like to see if the collection
	 *            is empty
	 * @throws IllegalArgumentException
	 ...
	 * @param message
	 *            the exception message you would like to see if the map is
	 *            empty
	 * @throws IllegalArgumentException
	 *             if the map is empty
	 */
	 ...
	 * <p>
	 * Validate an argument, throwing <code>IllegalArgumentException</code> if
	 * the argument String is empty (<code>null</code> or zero length).
	 * </p>
	 * 
	 * <pre>
	 ...
	 * @param message
	 *            the exception message you would like to see if the string is
	 *            empty
	 * @throws IllegalArgumentException
	 ...
	 * <p>
	 * Validate an argument, throwing <code>IllegalArgumentException</code> if
	 * the argument array has <code>null</code> elements or is <code>null</code>
	 * .
	 * </p>
	 * 
	 * <pre>
	 ...
	 * 
	 * <p>
	 * If the array is null then the message in the exception is 'The validated
	 * object is null'.
	 * </p>
	 * 
	 * @param array
	 *            the array to check
	 * @param message
	 *            the exception message if the array has <code>null</code>
	 *            elements
	 * @throws IllegalArgumentException
	 *             if the array has <code>null</code> elements or is
	 *             <code>null</code>
	 */
	 ...
	 * 
	 * <p>
	 * If the array has a null element the message in the exception is 'The
	 * validated array contains null element at index: '.
	 * </p>
	 * 
	 * <p>
	 * If the array is null then the message in the exception is 'The validated
	 ...
	 * <p>
	 * Validate an argument, throwing <code>IllegalArgumentException</code> if
	 * the argument Collection has <code>null</code> elements or is
	 * <code>null</code>.
	 * </p>
	 * 
	 * <pre>
	 ...
	 * 
	 * <p>
	 * If the collection is null then the message in the exception is 'The
	 ...
	 *            elements
	 * @throws IllegalArgumentException
	 *             if the collection has <code>null</code> elements or is
	 *             <code>null</code>
	 */
	 ...
	 * 		&quot;Collection has invalid elements&quot;);
	 * </pre>
	 * 
	 * @param collection
