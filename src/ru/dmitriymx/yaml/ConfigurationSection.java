...
/**
 * Represents a section of a {@link ru.dmitriymx.yaml.Configuration}
 */
public interface ConfigurationSection {
     ...
     * {@link ru.dmitriymx.yaml.ConfigurationSection}s (and their children, etc). These will be in a
     ...
     * any child {@link ru.dmitriymx.yaml.ConfigurationSection}s (and their children, etc). These
    ...
    /**
     * Checks if this {@link ru.dmitriymx.yaml.ConfigurationSection} contains the given path.
     * <p />
    ...
    /**
     * Checks if this {@link ru.dmitriymx.yaml.ConfigurationSection} has a value set for the given path.
     * <p />
     * If the value for the requested path does not exist but a default value has
    ...
    /**
     * Gets the path of this {@link ru.dmitriymx.yaml.ConfigurationSection} from its root {@link ru.dmitriymx.yaml.Configuration}
     * <p />
     * For any {@link ru.dmitriymx.yaml.Configuration} themselves, this will return an empty string.
     * <p />
    ...
    /**
     * Gets the name of this individual {@link ru.dmitriymx.yaml.ConfigurationSection}, in the path.
     * <p />
    ...
    /**
     * Gets the root {@link ru.dmitriymx.yaml.Configuration} that contains this {@link ru.dmitriymx.yaml.ConfigurationSection}
     * <p />
     * For any {@link ru.dmitriymx.yaml.Configuration} themselves, this will return its own object.
     * <p />
     * If the section is no longer contained within its root for any reason, such as
     * being replaced with a different value, this may return null.
     *
    ...
    /**
     * Gets the parent {@link ru.dmitriymx.yaml.ConfigurationSection} that directly contains this
     * {@link ru.dmitriymx.yaml.ConfigurationSection}.
     * <p />
     * For any {@link ru.dmitriymx.yaml.Configuration} themselves, this will return null.
     * <p />
     ...
     * regardless of if a default has been identified in the root {@link ru.dmitriymx.yaml.Configuration}.
     *
     * @param path Path of the Object to get.
     ...
     * {@link ru.dmitriymx.yaml.Configuration}s or {@link ru.dmitriymx.yaml.ConfigurationSection}s, please use
    ...
    /**
     * Creates an empty {@link ru.dmitriymx.yaml.ConfigurationSection} at the specified path.
     * <p />
     * Any value that was previously set at this path will be overwritten. If the
     * previous value was itself a {@link ru.dmitriymx.yaml.ConfigurationSection}, it will be orphaned.
     *
    ...
    /**
     * Creates a {@link ru.dmitriymx.yaml.ConfigurationSection} at the specified path, with specified values.
     * <p />
     * Any value that was previously set at this path will be overwritten. If the
     * previous value was itself a {@link ru.dmitriymx.yaml.ConfigurationSection}, it will be orphaned.
     *
    ...
    /**
     * Gets the equivalent {@link ru.dmitriymx.yaml.ConfigurationSection} from the default {@link ru.dmitriymx.yaml.Configuration} defined in {@link #getRoot()}.
     * <p />
     * If the root contains no defaults, or the defaults doesn't contain a value
     * for this path, or the value at this path is not a {@link ru.dmitriymx.yaml.ConfigurationSection} then
     ...
     * <p />
     * If no source {@link ru.dmitriymx.yaml.Configuration} was provided as a default collection,
     * then a new {@link ru.dmitriymx.yaml.MemoryConfiguration} will be created to hold the new default
     * value.
     * <p />
